...
project = django_crucrudile.__title__
copyright = django_crucrudile.__copyright__
...
version = '.'.join(django_crucrudile.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = django_crucrudile.__version__
