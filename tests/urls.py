...
test_patterns = patterns(
    ...
    url(r'^test/test-specific-create/of-(?P<specific_key>\w+)/(?P<specific_value>\d+)$',
        SpecificCreateView.as_view(model=TestSpecificCreatableModel),
        name='test-specific-creatable-model-specific-create'),
